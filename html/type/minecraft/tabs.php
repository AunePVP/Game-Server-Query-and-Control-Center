    ...
    <tr>
        <td style="padding: 5px 0 5px 5px;vertical-align: top;";>
            <div style="text-align: left;">
                ...
                <div class="hbanner">
                    <div class="hchartdiv">
                        <p style="text-align: left;border-bottom: solid;border-bottom: solid; border-color: rgb(70,70,70); margin: 0 0 8px 0; padding: 3px 0;"><?php echo $titlename ?></p>
                        <div class="flex">
                            ...
                            <g>
                                ...
                                <path d="M26.98,2.64C41.88,2.64 53.96,14.72 53.96,29.62C53.96,44.52 41.88,56.6 26.98,56.6C12.08,56.6 0,44.52 0,29.62C0,14.72 12.08,2.64 26.98,2.64ZM26.98,13.72L41.46,31.62L32.47,31.62L32.47,41.14L21.49,41.14L21.49,31.62L12.5,31.62L26.98,13.72Z" style="fill:rgb(107,190,102);"/>
                                    ...
                                    <div class="flex">
                                        ...
                                        <p><?php //echo $countplayers . '/' . $maxplayers; ?>0/20</p>
                                    </div>
                                </div>
                            </div>
                            <canvas id="Chart<?php echo $ServerID ?>" class="hchart" width="440" height="110"></canvas>
                        </div>
                    </div>
                    <script>
